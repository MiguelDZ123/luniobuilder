...
const PricingTabs: React.FC<PricingTabsProps> = ({ hasSession }) => {
    ...
    return (
        <div className='flex flex-col justify-between min-h-screen'>
            <div className='flex flex-col md:flex-row px-[15%] justify-center items-center gap-8 mt-20'>
                <div className='flex flex-col items-center justify-center gap-6'>
                    <div className='rounded-3xl p-5 text-center'>
                        <h1 className='text-4xl font-bold'>The Affordable Plans</h1>
                        <div>
            ...
            <div className='flex flex-col md:flex-row px-[15%] justify-center items-center gap-8 mt-10'>
                ...
                <div className='bg-white p-6 md:w-1/3 border-3 border-slate-500/5'>
                    <div className='flex flex-row items-center gap-2 mb-2'>
                        ...
                        <span className='flex text-sm text-green-500 font-semibold mb-2 border border-green-500/40 py-1 px-2 rounded-2xl'>Limited Time Offer</span>
                        {billing === 'annually' && <span className='flex text-xs text-yellow-500 font-semibold border mb-2 border-yellow-500/40 bg-amber-300/20 py-1 px-2 rounded-2xl'>Save 17%</span>}
                    </div>
            ...
            <div className='flex justify-between bg-[#111114] py-5 w-full text-center text-gray-500 text-xs px-[15%] mt-20'>
