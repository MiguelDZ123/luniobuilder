...
export default function SignIn() {
  return (
    ...
    >
      <button type="submit" className="flex flex-row text-white border border-white rounded-full px-3 py-1 items-center gap-2 hover:bg-white/10 transition-colors">
