...
<body>
  ...
  return (
    <header className="h-12 bg-[#0d1117] border-b border-gray-800 flex items-center px-4 gap-3 z-50 flex-shrink-0">
      {/* Logo */}
      <div className="flex items-center gap-2 mr-2">
        <span className="text-white font-semibold text-sm tracking-tight">LUNIO Builder</span>
      </div>
      ...
      <button
        onClick={exportHTML}
        className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 border border-gray-700 rounded-lg text-xs font-medium transition-colors"
      >
        <Download size={13} />
        Export
      </button>
      ...
      <div className="relative">
        <div className="flex">
          <button
            ...
            className={`flex items-center gap-1.5 pl-3 pr-2 py-1.5 rounded-l-lg text-xs font-medium transition-all ${
              published
